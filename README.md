...
<p>Once you run it, type in 'SFTP' and press enter.
Now, we are going to setup our server connection SFTP is configured through a JSON file maintaining the following structure, we recommend this configuration for work with <em>xyos</em>:</p>
